export abstract class WatchedList<T> {
  public currentItems: T[] // Itens do Array - Valor atual apos adições e remoções
  private initial: T[] // Dados iniciais da lista
  private new: T[] // Itens que o usuário Adicionou
  private removed: T[] // Itens que o usuário removeu
